...
async function main() {
  ...
  try {
    ...
    console.log('   • Customer Dashboard: http://localhost:4321/customer/login');
    console.log('');
    console.log('💡 Next Steps:');
    console.log('   1. Create a Strapi admin user: cd backend && npm run strapi admin:create-user');
    console.log('   2. Start the application: pnpm dev');
    console.log('   3. Login to the customer dashboard with the demo credentials above');
