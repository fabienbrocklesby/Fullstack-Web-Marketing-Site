  ...
  aiEngraveAssistant(ctx, {
    ...
    return auditLog("ai_engrave_assistant", {
      ...
      metadata: {
        ...
        imageDownscaled: imageDownscaled || false,
        imageTransformed: imageTransformed || false,
        originalBytes: originalBytes || null,
        finalBytes: finalBytes || null,
        originalMimeType: originalMimeType || null,
        finalMimeType: finalMimeType || null,
        framesUsed: framesUsed || null,
        originalDimensions: originalDimensions || null,
        finalDimensions: finalDimensions || null,
        error: error || null,
      },
    });
  },
